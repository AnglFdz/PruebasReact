                    ...
                    <div className="App">
                        ...
                        <div className="grid">
                            ...
                            <div className='lg:col-6 md:col-3'>
                               {/* Pruebas de juegos con los colores de primeflex */} 
                                <div style={{ color: 'white', borderRadius: 'var(--border-radius)', padding: '3rem' }}
                                    className='bg-primary hover:bg-indigo-400 border-3 hover:border-round hover:border-red-900' >
                        ...
                        <div>
                            {
                                loading ? <h1>Buscando: {buscar}</h1>
                                    : buscar === '' 
                                    && !loading ? 'No se ha encontrado nada' : null
                            }
                        </div>
